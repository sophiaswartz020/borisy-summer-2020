// Title: 1.9-batchprocessing-color.ijm
...
function processFile(input, output, file) {
	...
	for (j=1; j<9; j++) { 
		...
		// a="["+nameOrig+"]";
		// print(a); 
		run("Set Measurements...", "area mean min integrated median display redirect=[mixed FOV2.tif] decimal=3"); // try a FOVid combination
		print(nameOrig); // titleOrig instead?
