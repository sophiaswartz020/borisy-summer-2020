// Title: 1.0-batchprocessing_v2.0-minsizemod.ijm
...
function processFile(input, output, file) {
	...
	for (j=1; j<9; j++) { 
		...
		run("Analyze Particles...", "size=0.45-Infinity display include summarize add"); // CHANGED SIZE RANGE TO 0.45 - INFINITY UM^2 and ADD ROIs command
    // Similar modifications were performed with size = 0.25-Infinity or size = 0.40-Infinity, all showing over-outlining as compared to size = 0.50-Infinity
